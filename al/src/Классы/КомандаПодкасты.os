...
Процедура НастроитьКоманду(Знач Команда, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьПозиционныйПараметрКоманды(Команда, "create", "создание нового планового подкаста");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач Приложение) Экспорт
	...
	ПараметрСоздания = ПараметрыКоманды["create"];
	ПараметрЧтения = ПараметрыКоманды["read"];
	...
	Если ПараметрСоздания <> Неопределено Тогда
		МенеджерПодкастов.СоздатьСКонтролем(МенеджерСущностей);
	ИначеЕсли ПараметрОбновления <> Неопределено Тогда
		МенеджерПодкастов.ОбновитьСКонтролем(МенеджерСущностей);
	ИначеЕсли ПараметрЧтения <> Неопределено Тогда
		МенеджерПодкастов.ПрочитатьВсе(МенеджерСущностей);
	Иначе
		МенеджерПодкастов.ПрочитатьВсе(МенеджерСущностей);
	КонецЕсли;
